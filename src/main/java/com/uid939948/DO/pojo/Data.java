...
public class Data {
    ...
    public void setBlind_gift(Blind_gift blind_gift) {
         this.blind_gift = blind_gift;
     }
     public Blind_gift getBlind_gift() {
         return blind_gift;
     }
    ...
    public void setCombo_stay_time(int combo_stay_time) {
     ...
     public int getCombo_stay_time() {
         return combo_stay_time;
     }

    public void setCombo_total_coin(long combo_total_coin) {
         this.combo_total_coin = combo_total_coin;
     }
     public long getCombo_total_coin() {
         return combo_total_coin;
     }
    ...
    public void setIs_join_receiver(boolean is_join_receiver) {
         this.is_join_receiver = is_join_receiver;
     }
     public boolean getIs_join_receiver() {
         return is_join_receiver;
     }

    public void setIs_naming(boolean is_naming) {
         this.is_naming = is_naming;
     }
     public boolean getIs_naming() {
         return is_naming;
     }
    ...
    public void setSuper1(int super1) {
         this.super1 = super1;
     }
